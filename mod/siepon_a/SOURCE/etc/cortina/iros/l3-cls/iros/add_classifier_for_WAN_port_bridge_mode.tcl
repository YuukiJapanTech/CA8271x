...
#set port_range_key [ ca_classifier_range_create ]
#set dst_port_range_key [ ca_classifier_range_create ]
...
#### set src_port
ca_classifier_key_set_src_port $key 0x80007

#### set src_intf
ca_classifier_key_set_src_intf $key 1

#### set ethertype
ca_classifier_l2_set_ethertype $l2_key 0x0806
#### set src mac
#set mac_sa [ ca_mac_addr_create 0x5c 0x26 0x0a 0x76 0xb0 0xf1 ]
#ca_classifier_l2_set_mac_sa $l2_key $mac_sa
#### set dst mac
#set mac_da [ ca_mac_addr_create 0x00 0x13 0x25 0x00 0x00 0x02 ]
#ca_classifier_l2_set_mac_da $l2_key $mac_da
#### set is_multicast
...
#### set vlan count
ca_classifier_l2_set_vlan_count $l2_key 0
...
#ca_classifier_l2_set_vlan_otag $l2_key $outer_vlan_key
...
#ca_classifier_l2_set_vlan_itag $l2_key $inner_vlan_key
...
#### set l4 src_port
#ca_classifier_range_set_min $port_range_key 60
#ca_classifier_range_set_max $port_range_key 70
#ca_classifier_l4_set_src_port $l4_key $port_range_key
#### set l4 dst_port
#ca_classifier_range_set_min $dst_port_range_key 60
#ca_classifier_range_set_max $dst_port_range_key 70
...
#### set src mac mask
## ca_classifier_l2_mask_set_mac_sa $l2_mask 0x3f
#### set dst mac mask
## ca_classifier_l2_mask_set_mac_da $l2_mask 0x3f
#### set is_multicast
...
#### set port
ca_classifier_action_dest_set_port $dest 0x19

ca_classifier_action_set_dest $action $dest

#### set flow_id
ca_classifier_handle_set_flow_id $action_handle 100

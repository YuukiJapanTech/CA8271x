...
#   LPM profile #4 (t3ctrl)
#   rst_ctrl 0x23
#   dest 3001:abcd:0002:0001:1234::/80
#   NextHop_ID 0x23
...
lpm_tbl_entry_set_data		$lpm_0	0xbbbbcccc
lpm_tbl_entry_set_mask		$lpm_0	0
lpm_tbl_entry_set_attr		$lpm_0	3
lpm_tbl_entry_set_rst_idx	$lpm_0	0x23
...
lpm_tbl_entry_set_data		$lpm_1	0x1234aaaa
lpm_tbl_entry_set_mask		$lpm_1	16
lpm_tbl_entry_set_attr		$lpm_1	3
lpm_tbl_entry_set_rst_idx	$lpm_1	0x23
...
lpm_tbl_entry_set_data		$lpm_2	0x00020001
lpm_tbl_entry_set_mask		$lpm_2	32
lpm_tbl_entry_set_attr		$lpm_2	3
lpm_tbl_entry_set_rst_idx	$lpm_2	0x23
...
lpm_tbl_entry_set_data		$lpm_3	0x3001abcd
lpm_tbl_entry_set_mask		$lpm_3	32
lpm_tbl_entry_set_attr		$lpm_3	3
lpm_tbl_entry_set_rst_idx	$lpm_3	0x23

## Add entry to 6RD table index 0
##
...
##
## LAN-to-WAN, CE-to-BR, from port 1 to port 7
##   mac_sa = 00-c0-a8-12-34-56
##   mac_da = 00-13-25-00-00-02
##   v6_src = 2001:a801:0a00::1
##   v6_dest = 3001:0000:0100::1
##   sport = 63
##   dport = 63
##   NO vid
##
## LAN-to-WAN, CE-to-CE, from port 1 to port 7
##   mac_sa = 00-c0-a8-12-34-56
##   mac_da = 00-13-25-00-00-02
##   v6_src = 2001:a801:0a00::1
##   v6_dest = 2001:a864:0a00::1
##   sport = 63
##   dport = 63
##   NO vid
##
...
##   outer v4_src = 192.0.0.1
##   outer v4_dest = 192.168.1.10
##   inner v6_src = 3001:0000:0100::1
##   inner v6_dest = 2001:a801:0a00::1
##   sport = 63
##   dport = 63
##   NO vid
##
## WAN2LAN, CE-to-CE, from port 0x7 to port 0x1
##   mac_sa = 00-c0-a8-ab-cd-ef
##   mac_da = 00-13-25-00-00-01
##   outer v4_src = 192.168.100.10
##   outer v4_dest = 192.168.1.10
##   inner v6_src = 2001:a864:0a00::1
##   inner v6_dest = 2001:a801:0a00::1
##   sport = 63
##   dport = 63
##   NO vid
...
l3pe_sixrd_tbl_entry_set_ingr_chk_en	$sixrd_entry	1
l3pe_sixrd_tbl_entry_set_br_only	$sixrd_entry	0
l3pe_sixrd_tbl_entry_set_ipsa_mtch	$sixrd_entry	1
...
l3pe_sixrd_tbl_entry_set_v6_prfx	$sixrd_entry	0x2001000000000000
l3pe_sixrd_tbl_entry_set_v6_prfx_len	$sixrd_entry	16
l3pe_sixrd_tbl_entry_set_v4_msk_len	$sixrd_entry	8
l3pe_sixrd_tbl_entry_set_ce_v4_ip	$sixrd_entry	0xc0a8010a

...
aal_hash_key_set_l4_dp_exact_range	$hkey	63
aal_hash_key_set_l4_sp_exact_range	$hkey	63
...
aal_hash_key_set_top_vid		$hkey	0
aal_hash_key_set_top_tpid_enc		$hkey	0
aal_hash_key_set_vlan_cnt		$hkey	0
...
aal_hash_key_set_ethertype		$hkey	0x0800
aal_hash_key_set_mac_sa_0		$hkey	0x56
aal_hash_key_set_mac_sa_1		$hkey	0x34
aal_hash_key_set_mac_sa_2		$hkey	0x12
aal_hash_key_set_mac_sa_3		$hkey	0xa8
aal_hash_key_set_mac_sa_4		$hkey	0xc0
aal_hash_key_set_mac_sa_5		$hkey	0x00
...
# MDATA
aal_hash_key_set_mdata			$hkey	0x7
...
# Hash Control
aal_hash_key_set_hkey_id		$hkey	0

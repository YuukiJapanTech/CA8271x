...
# group 5
aal_hash_action_set_ip_sa_l_vld			$hact	0
...
aal_hash_action_set_ip_ttl			$hact	0
...
# group 10
aal_hash_action_set_mac_sa_vld			$hact	0
aal_hash_action_set_mac_sa_0			$hact	0x01
aal_hash_action_set_mac_sa_1			$hact	0x00
aal_hash_action_set_mac_sa_2			$hact	0x00
aal_hash_action_set_mac_sa_3			$hact	0xc2
aal_hash_action_set_mac_sa_4			$hact	0x50
aal_hash_action_set_mac_sa_5			$hact	0x00

# group 11
aal_hash_action_set_mac_da_vld			$hact	1
aal_hash_action_set_mac_da_0			$hact	0xef
aal_hash_action_set_mac_da_1			$hact	0xcd
aal_hash_action_set_mac_da_2			$hact	0xab
aal_hash_action_set_mac_da_3			$hact	0xa8
aal_hash_action_set_mac_da_4			$hact	0xc0
...
aal_hash_action_set_mdata_w_1			$hact	0x0007
...
aal_hash_action_set_dpid_pri			$hact	0
aal_hash_action_set_permit			$hact	0
aal_hash_action_set_deepq			$hact	0
aal_hash_action_set_mcgid			$hact	0
aal_hash_action_set_mc				$hact	0

# group 19
aal_hash_action_set_chk_msk_ptr			$hact	0
...
aal_hash_action_set_t5_ctrl_vld			$hact	1
aal_hash_action_set_t5_ctrl			$hact	0xf

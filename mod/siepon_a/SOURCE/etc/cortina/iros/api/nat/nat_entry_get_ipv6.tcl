...
set		NEW_L4_SRC_PORT			0
set		NEW_L4_DST_PORT			0
set		AGING_TIMER			0

;#	Enable change SIP(0x1 << 0)
;#	Enable change DIP(0x1 << 1)
;#	Enable change port ID(0x1 << 2)
set		XLATE_FLAGS			0				;#	SNAT:5	DNAT:6

set		SRC_IP_ADDR_0			0x00000230			;# 2050::230/128
set		SRC_IP_ADDR_1			0x00000000			;#
set		SRC_IP_ADDR_2			0x00000000			;#
set		SRC_IP_ADDR_3			0x20500000			;#

set		DST_IP_ADDR_0			0x00000210			;# 1060::210/128
set		DST_IP_ADDR_1			0x00000000			;#
set		DST_IP_ADDR_2			0x00000000			;#
set		DST_IP_ADDR_3			0x10600000			;#

set		NEW_SRC_IP_ADDR_0		0				;# 1160::220/128
set		NEW_SRC_IP_ADDR_1		0				;#
set		NEW_SRC_IP_ADDR_2		0				;#
set		NEW_SRC_IP_ADDR_3		0				;#

set		NEW_DST_IP_ADDR_0		0				;# 1060::210/128
set		NEW_DST_IP_ADDR_1		0				;#
set		NEW_DST_IP_ADDR_2		0				;#
set		NEW_DST_IP_ADDR_3		0				;#
...
ca_nat_entry_get	0	$nat_entry

ca_nat_entry_dump	$nat_entry

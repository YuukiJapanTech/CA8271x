...
ca_map_config_set_psid_id $tcfg_map_e 0x35
...
ca_l3_intf_set_intf_id $intf_wan 49
...
# nexthop 192.168.1.101, 00:00:00:00:01:65, intf_id 2

set ip [ ca_ip_address_create ]
set ip_addr [ ca_l3_ip_addr_create ]
ca_l3_ip_addr_set_ipv4_addr $ip_addr 0xc0a80165
ca_ip_address_set_addr_len $ip 32
ca_ip_address_set_afi $ip 0
ca_ip_address_set_ip_addr $ip $ip_addr

set mac_addr [ ca_mac_addr_create 0x00 0x00 0x00 0x00 0x01 0x65 ]
...
# nexthop 1.2.3.4, 00:00:00:00:64:64, intf_id 49
...
ca_l3_nexthop_set_attr_flags $nh 1
ca_l3_nexthop_set_addr $nh $ip
ca_l3_nexthop_set_intf_id $nh 49
ca_l3_nexthop_set_da_mac $nh $mac_addr
ca_l3_nexthop_set_aging_timer $nh 0

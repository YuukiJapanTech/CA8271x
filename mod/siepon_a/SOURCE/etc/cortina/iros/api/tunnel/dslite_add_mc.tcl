...
##
## upstream for encap: (Encapsulation is done by pure SW)
## mac_sa = 00-00-00-00-01-64 or any
## mac_da = 01-00-5e-00-00-01
## inner_ipv4sa = 192.168.1.100
## inner_ipv4da = 239.0.0.1 (not sure)
##
## downstream for decap:
## mac_sa = 00-00-00-00-64-64 or any
## mac_da = 33-33-ef-00-00-01
## outer_ipv6sa = 3001::c000:0001 (aftr)
## outer_ipv6da = ff38::ef00:0001 (b4)
## inner_ipv4sa = 192.0.0.1
## inner_ipv4da = 239.0.0.1

# tunnnel src(local) = 2001::/64
...
ca_l3_ip_addr_set_ipv6_addr $ip 0xffffffff 2
ca_l3_ip_addr_set_ipv6_addr $ip 0xffffffff 3
ca_ip_address_set_addr_len $src 128
ca_ip_address_set_afi $src 1
ca_ip_address_set_ip_addr $src $ip

# tunnnel dest(remote) = 3001::/64
...
ca_dslite_config_set_mc_flag $tcfg_dslite 1

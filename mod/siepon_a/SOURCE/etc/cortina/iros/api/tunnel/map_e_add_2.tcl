## tunnel type 9 (MAP-E)
##
## The example follows RFC7597 example 1~3.
...
set tcfg_map_e [ ca_map_config_create ]
ca_map_config_set_map_type $tcfg_map_e 0
ca_map_config_set_ipv6_prefix $tcfg_map_e $ipv6_prefix
ca_map_config_set_ipv4_prefix $tcfg_map_e $ipv4_prefix
ca_map_config_set_ea_bit_length $tcfg_map_e 16
ca_map_config_set_psid_offset $tcfg_map_e 6
ca_map_config_set_psid_length $tcfg_map_e 8
ca_map_config_set_psid_id $tcfg_map_e 0x36
ca_map_config_set_validation_check_failed_dest_port $tcfg_map_e 0x1f
ca_map_config_set_egress_tc_copied_from_ipv4_tos $tcfg_map_e 0
ca_map_config_set_egress_tc_value $tcfg_map_e 0
ca_map_config_set_egress_hoplimit_value $tcfg_map_e 100
ca_map_config_set_egress_flow_label_value $tcfg_map_e 0

set tcfg_union [ ca_tunnel_cfg_union_create ]
ca_tunnel_cfg_union_set_map $tcfg_union $tcfg_map_e

set tcfg [ ca_tunnel_cfg_create ]
ca_tunnel_cfg_set_type $tcfg 9
...
ca_l3_intf_set_intf_id $intf_wan 50
...
# nexthop 192.168.1.102, 00:00:00:00:01:66, intf_id 2

set ip [ ca_ip_address_create ]
set ip_addr [ ca_l3_ip_addr_create ]
ca_l3_ip_addr_set_ipv4_addr $ip_addr 0xc0a80166
ca_ip_address_set_addr_len $ip 32
ca_ip_address_set_afi $ip 0
ca_ip_address_set_ip_addr $ip $ip_addr

set mac_addr [ ca_mac_addr_create 0x00 0x00 0x00 0x00 0x01 0x66 ]
...
# nexthop 1.2.3.4, 00:00:00:00:64:64, intf_id 50

set ip [ ca_ip_address_create ]
set ip_addr [ ca_l3_ip_addr_create ]
ca_l3_ip_addr_set_ipv4_addr $ip_addr 0x01020304
ca_ip_address_set_addr_len $ip 32
ca_ip_address_set_afi $ip 0
ca_ip_address_set_ip_addr $ip $ip_addr
...
ca_l3_nexthop_set_attr_flags $nh 1
ca_l3_nexthop_set_addr $nh $ip
ca_l3_nexthop_set_intf_id $nh 50
ca_l3_nexthop_set_da_mac $nh $mac_addr
ca_l3_nexthop_set_aging_timer $nh 0

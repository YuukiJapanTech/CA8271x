...
us_rate_manager_global_control_set_default_stream_bandwidth_percentage          $config         30
...
us_rate_manager_global_control_set_max_egress_rate             $config   400000
...
source iros_cls_set_cpu256s.tcl

...
ca_l3_ip_addr_set_ipv4_addr  $ip_addr_wan 0

ca_ip_address_set_ip_addr  $ip_address_wan $ip_addr_wan
ca_ip_address_set_addr_len $ip_address_wan 0
...
ca_l3_ip_addr_set_ipv4_addr  $ip_addr_lan 0x0

ca_ip_address_set_ip_addr  $ip_address_lan $ip_addr_lan
ca_ip_address_set_addr_len $ip_address_lan 0

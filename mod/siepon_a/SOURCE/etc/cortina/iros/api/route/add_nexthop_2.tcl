...
ca_l3_ip_addr_set_ipv4_addr  $ip_addr_wan 0xc0a86466
...
## set MAC address
set mac_addr_wan [ ca_mac_addr_create 0x00 0xc0 0x52 0x00 0x02 0x01 ]
...
ca_l3_ip_addr_set_ipv4_addr  $ip_addr_lan 0xc0a80166
...
## set MAC address
set mac_addr_lan [ ca_mac_addr_create 0x00 0xc0 0x52 0x00 0x02 0x02 ]

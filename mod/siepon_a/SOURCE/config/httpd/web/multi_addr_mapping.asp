...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang("549" "LANG_ADDRESS_MAPPING_RULE"); %><% multilang("197" "LANG_CONFIGURATION"); %></font></h2>
<form action=/boaform/formAddressMap method=POST name="addressMap">
<table border=0 width="500" cellspacing=4 cellpadding=0>
  <tr><td><font size=2>
    <% multilang("550" "LANG_THIS_PAGE_IS_USED_TO_SET_AND_CONFIGURE_THE_ADDRESS_MAPPING_RULE_FOR_YOUR_DEVICE"); %> <% multilang("551" "LANG_THE_MAXIMUM_NUMBER_OF_ENTRIES_ARE_16"); %>
  </font></td></tr>
  <tr><td><hr size=1 noshade align=top></td></tr>
</table>
<table border=0 width="500" cellspacing=4 cellpadding=0>
  <tr>
      <td width="30%"><font size=2><b><% multilang("224" "LANG_TYPE"); %>:</b>
      <select size="1" name="addressMapType" onChange="checkState()">
      <option value=1><% multilang("552" "LANG_ONE_TO_ONE"); %></option>
      <option value=2><% multilang("553" "LANG_MANY_TO_ONE"); %></option>
      <option value=3><% multilang("554" "LANG_MANY_TO_MANY_OVERLOAD"); %></option>
      <option value=4><% multilang("555" "LANG_ONE_TO_MANY"); %></option>
      </select>
      </td>
  </tr>
  <tr>
...
<table border=0 width=500>
  <tr><td><hr size=1 noshade align=top></td></tr>
  <tr><font size=2><b><% multilang("560" "LANG_CURRENT_ADDRESS_MAPPING_TABLE"); %>:</b></font></tr>
<% AddressMapList(); %>
</table>
 <br><input type="submit" value="<% multilang("183" "LANG_DELETE_SELECTED"); %>" name="deleteSelAddressMap" onClick="return deleteClick()">&nbsp;&nbsp;
     <input type="submit" value="<% multilang("184" "LANG_DELETE_ALL"); %>" name="deleteAllAddressMap" onClick="return deleteAllClick()">&nbsp;&nbsp;&nbsp;
     <input type="hidden" value="/multi_addr_mapping.asp" name="submit-url">
 <script>

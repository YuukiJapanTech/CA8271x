...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang("17" "LANG_MAC_FILTERING"); %></font></h2>
...
<tr>
 ...
 <td>
 <select name=dir>
  <option select value=0><% multilang("327" "LANG_BOTH"); %></option>
  <option value=1><% multilang("319" "LANG_SOURCE"); %></option>
  <option value=2><% multilang("320" "LANG_DESTINATION"); %></option>
 </select>
 </td>
</tr> -->
<tr>
 <td><font size=2>
 <b><% multilang("72" "LANG_MAC_ADDRESS"); %>: </b></font>

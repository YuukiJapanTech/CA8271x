...
<title><% multilang("780" "LANG_IP_ROUTE_TABLE"); %></title>
</head>
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang("780" "LANG_IP_ROUTE_TABLE"); %></font></h2>
<table border=0 width="480" cellspacing=0 cellpadding=0>
  <tr><td><font size=2>
  <% multilang("781" "LANG_THIS_TABLE_SHOWS_A_LIST_OF_DESTINATION_ROUTES_COMMONLY_ACCESSED_BY_YOUR_NETWORK"); %>
  </font></td></tr>

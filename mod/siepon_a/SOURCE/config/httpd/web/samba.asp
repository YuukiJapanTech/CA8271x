...
<title>Samba<% multilang("197" "LANG_CONFIGURATION"); %></title>
...
<blockquote>
<h2><font color="#0000FF">Samba<% multilang("197" "LANG_CONFIGURATION"); %></font></h2>
<table border=0 width="500" cellspacing=4 cellpadding=0>
 <tr><td><font size=2>
 <% multilang("1049" "LANG_THIS_PAGE_LET_USER_TO_CONFIG_SAMBA"); %>
 </font></td></tr>
...
<table>
 ...
 <td><font size=2>
  <input type="radio" value="0" name="sambaCap" onClick="changeSambaCap();" <% checkWrite("samba-cap0"); %>><% multilang("206" "LANG_DISABLE"); %>&nbsp;&nbsp;
  <input type="radio" value="1" name="sambaCap" onClick="changeSambaCap();" <% checkWrite("samba-cap1"); %>><% multilang("207" "LANG_ENABLE"); %>
 </font></td>
 </tr>
<tbody id="conf">
 <tr <% checkWrite("nmbd-cap"); %>>
 <td><font size=2><b>NetBIOS <% multilang("604" "LANG_NAME"); %>&nbsp;:</b></font></td>
 <td><font size=2><input type="text" name="netBIOSName" maxlength="15"></font><td>
 </tr>
 <tr>
 <td><font size=2><b><% multilang("1050" "LANG_SERVER_STRING"); %>&nbsp;:</b></font></td>

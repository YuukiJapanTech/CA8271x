...
<tr <% checkWrite("rg_hidden_function"); %>><td><font size=2><b><% multilang("314" "LANG_INCOMING_DEFAULT_ACTION"); %></b>&nbsp;&nbsp;
    <input type="radio" name="inAct" value=0 <% checkWrite("ipf_in_act0"); %>><% multilang("312" "LANG_DENY"); %>&nbsp;&nbsp;
    <input type="radio" name="inAct" value=1 <% checkWrite("ipf_in_act1"); %>><% multilang("313" "LANG_ALLOW"); %>&nbsp;&nbsp;

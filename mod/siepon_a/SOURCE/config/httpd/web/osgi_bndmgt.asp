...
<title><% multilang("45" "LANG_GPON_SETTINGS"); %></title>
...
<body>
<blockquote>
<h2><font color="#0000FF"><% multilang("1042" "LANG_BUNDLE_MANAGEMENT"); %></font></h2>
<form action=/boaform/admin/formOsgiMgt method=POST name="osgimgt">
<table border=0 width="500" cellspacing=4 cellpadding=0>
  <tr><td><font size=2>
    <% multilang("1043" "LANG_THIS_PAGE_IS_USED_TO_MANAGE_OSGI_BUNDLES"); %>
  </font></td></tr>
